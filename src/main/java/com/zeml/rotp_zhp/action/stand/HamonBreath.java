 ...
 */
    ...
    public Optional<HermitPurpleEntity> getHermitPurple(LivingEntity player){
        return  player.level.getEntitiesOfClass(HermitPurpleEntity.class, player.getBoundingBox().inflate(3), EntityPredicates.ENTITY_STILL_ALIVE).stream()
