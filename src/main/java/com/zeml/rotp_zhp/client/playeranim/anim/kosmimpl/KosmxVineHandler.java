...
public class KosmxVineHandler extends KosmXWindupAttackHandler {

    public KosmxVineHandler(ResourceLocation id) {
        super(id);
    }
    @Override
    ...
    private static final ResourceLocation GRAPPLE = new ResourceLocation(RotpHermitPurpleAddon.MOD_ID, "vine");
