...
public class HermitPurpleEpicFightLayer <E extends LivingEntity, T extends LivingEntityPatch<E>, M extends BipedModel<E>> extends PatchedLayer<E, T, M, HermitoUserLayer<E, M>>{
    public static ResourceLocation HERMIT_LAYER = new  ResourceLocation(RotpHermitPurpleAddon.MOD_ID,"/textures/entity/stand/hermito_purple.png");


    @Override
    public void renderLayer(T t, E e, HermitoUserLayer<E, M> emHermitoUserNoSLimLayer, MatrixStack matrixStack, IRenderTypeBuffer iRenderTypeBuffer, int i, OpenMatrix4f[] openMatrix4fs, float v, float v1, float v2) {
